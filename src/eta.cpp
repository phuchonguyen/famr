...
arma::mat get_Aij(arma::mat B, int K, int t, int q_int = 0, 
                  arma::rowvec z_int = arma::zeros<arma::rowvec>(0)) {
...
// TODO TEST!!!
// [[Rcpp::export]]
arma::mat update_eta_gibbs_cpp(arma::mat eta, arma::mat B, arma::mat Theta, 
                               arma::mat Sigmay_inv, arma::vec sigmax_sqinv,
                               arma::mat Y, arma::mat X, int K, int p, int t,
